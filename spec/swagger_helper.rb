              ...
              character: {
                ...
                properties: {
                  ...
                  portrait_image: {
                    type: :string,
                    format: :binary,
                    description: 'Optional image file for the character portrait. Use multipart/form-data. Max 5 MB. Allowed: JPEG, PNG, WebP, GIF.'
                  },
                  cover_image: {
                    type: :string,
                    format: :binary,
                    description: 'Optional image file for the character cover. Use multipart/form-data. Max 15 MB. Allowed: JPEG, PNG, WebP, GIF.'
                  }
                }
              }
            }
